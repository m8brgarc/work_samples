...
?>
<div class="row">
    <h2 class="large-4 large-offset-4 medium-6 medium-offset-3 small-8 small-offset-2 columns subheader">Register</h2>
</div>
<form action="<?=$_SERVER['PHP_SELF'];?>" method="post" id="login-form" class="large-4 large-offset-4 medium-6 medium-offset-3 small-8 small-offset-2 columns">
    ...
    <div class="row text-center">
        ...
        <div class="small-6 columns">
            <input class="button radius small success" type="submit" id="submit" name="submit" value="Register">
        </div>
    </div>
</form>
